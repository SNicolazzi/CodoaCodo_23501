...
class Mensaje:
    ...
    #----------------------------------------------------------------
    def enviar_mensaje(self, nombre, telefono, email, consulta):
        sql = "INSERT INTO mensajes(nombre, telefono, email, mensaje, fecha_envio) VALUES (%s, %s, %s, %s, %s)"
        fecha_envio = datetime.datetime.now()
        valores = (nombre, telefono, email, consulta, fecha_envio)
    ...
    def mostrar_mensaje(self, id):
         sql = f"SELECT id, nombre, telefono, email, mensaje, fecha_envio, leido, gestion, fecha_gestion FROM mensajes WHERE id = {id}"
...
def agregar_consulta():
    ...
    if mensaje.enviar_mensaje(nombre, telefono, email, consulta):
